...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--answerer-model", default="qwen-turbo", help="Model for answer generation")
    parser.add_argument("--judge-model", default="qwen-turbo", help="Model for judging")
